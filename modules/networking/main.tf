...
locals {
  ...
  vnets = {
    hub_prod = {
      ...
      rg_name       = lookup(var.resource_group_names, "rg-network-hub-prod-swe", "rg-network-hub-prod-swe")
      address_space = ["10.0.0.0/22"]
      subnets = {
        "snet-mngt-prod-swe-001"   = "10.0.0.0/24"
        "snet-pe-prod-swe-001"     = "10.0.1.0/24"
        "AzureFirewallSubnet"      = "10.0.2.0/26"
        "snet-appgw-prod-swe-001"  = "10.0.2.64/26"
        "GatewaySubnet"            = "10.0.2.128/26"
        "AzureBastionSubnet"       = "10.0.2.192/26"
        "snet-dnsin-prod-swe-001"  = "10.0.3.0/27"
        "snet-dnsout-prod-swe-001" = "10.0.3.32/27"
      }
    }
    aks_prod = {
      name          = "vnet-aks-prod-swe"
      rg_name       = lookup(var.resource_group_names, "rg-network-aks-prod-swe", "rg-network-aks-prod-swe")
      address_space = ["10.0.4.0/22"]
      subnets = {
        "snet-aksworkload-prod-swe-001"   = "10.0.4.0/23"
        "snet-akssystem-prod-swe-001"     = "10.0.6.0/24"
        "snet-aksingress-prod-swe-001"    = "10.0.7.0/26"
        "snet-akspe-prod-swe-001"         = "10.0.7.64/26"
        "snet-aksmonitoring-prod-swe-001" = "10.0.7.128/27"
      }
    }
    dataai_prod = {
      name          = "vnet-dataai-prod-swe"
      rg_name       = lookup(var.resource_group_names, "rg-network-dataai-prod-swe", "rg-network-dataai-prod-swe")
      address_space = ["10.0.8.0/23"]
      subnets = {
        "snet-dataaipe-prod-swe-001"        = "10.0.8.0/25"
        "snet-dataaianalytics-prod-swe-001" = "10.0.8.128/25"
        "snet-dataaicompute-prod-swe-001"   = "10.0.9.0/25"
        "snet-dataaistreaming-prod-swe-001" = "10.0.9.128/26"
      }
    }
    apps_prod = {
      name          = "vnet-apps-prod-swe"
      rg_name       = lookup(var.resource_group_names, "rg-network-apps-prod-swe", "rg-network-apps-prod-swe")
      address_space = ["10.0.10.0/24"]
      subnets = {
        "snet-appsaca-prod-swe-001"       = "10.0.10.0/25"
        "snet-appsmessaging-prod-swe-001" = "10.0.10.128/26"
        "snet-appspe-prod-swe-001"        = "10.0.10.192/26"
      }
    }
    shared_prod = {
      name          = "vnet-shared-prod-swe"
      rg_name       = lookup(var.resource_group_names, "rg-network-shared-prod-swe", "rg-network-shared-prod-swe")
      address_space = ["10.0.11.0/24"]
      subnets = {
        "snet-sharedpe-prod-swe-001"     = "10.0.11.0/25"
        "snet-sharedapim-prod-swe-001"   = "10.0.11.128/26"
        "snet-shareddevops-prod-swe-001" = "10.0.11.192/27"
      }
    }
    hub_nprod = {
      name          = "vnet-hub-nprod-swe"
      rg_name       = lookup(var.resource_group_names, "rg-network-dev-swe", "rg-network-dev-swe")
      address_space = ["10.1.0.0/22"]
      subnets = {
        "snet-mngt-nprod-swe-001"   = "10.1.0.0/24"
        "snet-pe-nprod-swe-001"     = "10.1.1.0/24"
        "AzureFirewallSubnet"       = "10.1.2.0/26"
        "snet-appgw-nprod-swe-001"  = "10.1.2.64/26"
        "GatewaySubnet"             = "10.1.2.128/26"
        "AzureBastionSubnet"        = "10.1.2.192/26"
        "snet-dnsin-nprod-swe-001"  = "10.1.3.0/27"
        "snet-dnsout-nprod-swe-001" = "10.1.3.32/27"
      }
    }
    aks_nprod = {
      ...
      subnets = {
        "snet-aksworkload-nprod-swe-001"   = "10.1.4.0/23"
        "snet-akssystem-nprod-swe-001"     = "10.1.6.0/24"
        "snet-aksingress-nprod-swe-001"    = "10.1.7.0/26"
        "snet-aksmonitoring-nprod-swe-001" = "10.1.7.64/27"
        "snet-akspe-nprod-swe-001"         = "10.1.7.96/27"
      }
    }
    dataai_nprod = {
      ...
      subnets = {
        "snet-dataaipe-nprod-swe-001"        = "10.1.8.0/25"
        "snet-dataaianalytics-nprod-swe-001" = "10.1.8.128/25"
        "snet-dataaicompute-nprod-swe-001"   = "10.1.9.0/25"
        "snet-dataaistreaming-nprod-swe-001" = "10.1.9.128/26"
      }
    }
    apps_nprod = {
      ...
      subnets = {
        "snet-appsaca-nprod-swe-001"       = "10.1.10.0/25"
        "snet-appsmessaging-nprod-swe-001" = "10.1.10.128/26"
        "snet-appspe-nprod-swe-001"        = "10.1.10.192/26"
      }
    }
    shared_nprod = {
      ...
      subnets = {
        "snet-sharedpe-nprod-swe-001"     = "10.1.11.0/25"
        "snet-sharedapim-nprod-swe-001"   = "10.1.11.128/26"
        "snet-shareddevops-nprod-swe-001" = "10.1.11.192/27"
      }
    }
    onprem_prod = {
      ...
      subnets = {
        "snet-onpremusers-prod-swe-001"    = "172.16.0.0/22"
        "snet-onpremmngt-prod-swe-001"     = "172.16.4.0/24"
        "snet-onpremservers-prod-swe-001"  = "172.16.5.0/24"
        "snet-onpremdmz-prod-swe-001"      = "172.16.6.0/24"
        "snet-onpremsecurity-prod-swe-001" = "172.16.7.0/24"
        "snet-onprembackup-prod-swe-001"   = "172.16.8.0/24"
...
# =========================================================================
# DOMINIO HUB — NPROD/DEV (SUSCRIPCIÓN: PRODUCTION — rg-network-dev-swe)
# =========================================================================
...
# =========================================================================
# DOMINIO DATA & IA — NPROD/DEV (SUSCRIPCIÓN: PRODUCTION — rg-network-dev-swe)
# =========================================================================
...
# =========================================================================
# CAPA 2: APPLIANCES PERIMETRALES (todos viven en hub_prod)
# =========================================================================
...
resource "azurerm_application_gateway" "appgw" {
  ...
  gateway_ip_configuration {
    name      = "agw-ip-config"
    subnet_id = azurerm_subnet.hub_prod["hub_prod_snet-appgw-prod-swe-001"].id
  }
